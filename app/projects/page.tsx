...
const projects = [
  ...
  },
  {
    ...
    description: "AI assistant with voice recognition and natural language processing",
    longDescription:
      "Advanced AI companion that understands context, learns from interactions, and provides intelligent assistance.",
    tech: ["Python", "OpenAI", "Speech Recognition", "NLP", "FastAPI"],
    github: "https://github.com/user/smart-companion",
    demo: "https://smartcompanion.demo.com",
    type: "ai",
    difficulty: "Epic",
  ...
  },
  {
    ...
    longDescription: "Immersive RPG where players earn real cryptocurrency and NFTs through gameplay achievements.",
    tech: ["Solidity", "Web3.js", "React", "Ethereum", "IPFS"],
    github: "https://github.com/user/cryptoquest",
    demo: "https://cryptoquest.demo.com",
    type: "blockchain",
    difficulty: "Legendary",
  ...
  },
  {
    id: "social-platform",
    name: "DevConnect",
    description: "Social platform for developers with real-time collaboration",
    longDescription:
      "Connect with developers worldwide, share code, collaborate on projects, and build amazing things together.",
...
function EnhancedTechShowcase() {
  ...
  const technologies = [
    ...
    { name: "TypeScript", icon: "📘", color: "from-blue-500 to-blue-600", glow: "shadow-blue-500/50" },
    { name: "PostgreSQL", icon: "🐘", color: "from-gray-600 to-gray-700", glow: "shadow-gray-500/50" },
    { name: "MongoDB", icon: "🍃", color: "from-green-600 to-green-700", glow: "shadow-green-600/50" },
    { name: "Docker", icon: "🐳", color: "from-blue-400 to-blue-500", glow: "shadow-blue-400/50" },
    { name: "AWS", icon: "☁️", color: "from-orange-500 to-orange-600", glow: "shadow-orange-500/50" },
    { name: "TensorFlow", icon: "🧠", color: "from-pink-500 to-pink-600", glow: "shadow-pink-500/50" },
    { name: "React Native", icon: "📱", color: "from-cyan-500 to-cyan-600", glow: "shadow-cyan-500/50" },
