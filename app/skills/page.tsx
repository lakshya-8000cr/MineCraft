...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "Svelte", level: 70, experience: "6+ months" },
    ],
  },
  {
    id: "backend",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Adobe Creative Suite", level: 78, experience: "1+ year" },
      { name: "Blender", level: 65, experience: "6+ months" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "CI/CD", level: 88, experience: "2+ years" },
      { name: "Terraform", level: 70, experience: "6+ months" },
    ],
  },
  {
    id: "ai",
    ...
    skills: [
      ...
      { name: "Computer Vision", level: 65, experience: "6+ months" },
      { name: "NLP", level: 68, experience: "6+ months" },
    ],
  },
  {
    id: "security",
    ...
    skills: [
      ...
      { name: "Authentication", level: 88, experience: "2+ years" },
